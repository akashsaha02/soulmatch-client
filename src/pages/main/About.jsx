            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="">
                        ...
                        <Link to='/biodatas' className="text-white bg-me-teal px-4 py-2 lg:text-lg rounded hover:bg-me-pink mt-2 font-semibold playfair">Explore Now</Link>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {teamMembers.map((member, index) => (
                            ...
                            >
                                ...
                                />
                                <h3 className="text-2xl font-semibold text-gray-800 cinzel">
                                    {member.name}
                                </h3>
                ...
                <div className="space-y-10 py-12 bg-gray-50">
                    <SectionTitleHome
                        ...
                        subHeading="Empowering Connections, Building Bridges"
                    />
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="flex justify-center">
                            <img
                                ...
                                className="w-full rounded-lg shadow-lg object-cover md:max-w-lg"
                            />
                        </div>

                        {/* Text Section */}
                        <div className="space-y-4">
                            <h2 className="text-2xl font-semibold text-me-brown cinzel">
                                Making Meaningful Connections
                            </h2>
                            <p className="text-gray-700 text-lg leading-relaxed">
                                Our mission is to empower individuals to find meaningful connections by
                                leveraging the power of technology and empathy. We envision a world
                                where everyone has the opportunity to build lasting relationships in a
                                safe and inclusive environment.
                            </p>
                            <p className="text-gray-700 text-lg leading-relaxed">
                                At SoulMatch, we believe in creating a platform that bridges gaps,
                                nurtures trust, and celebrates diversity. Together, we can help you
                                discover the bonds that truly matter.
                            </p>
                        </div>
                    </div>
                </div>
