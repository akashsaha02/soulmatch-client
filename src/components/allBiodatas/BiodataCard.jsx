...
const BiodataCard = ({ biodata, handleViewProfile }) => {
  ...
  return (
    <div className="bg-white shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 relative overflow-hidden border border-me-brown">
      {/* Profile Image */}
      <div className="relative">
        ...
        <h3 className="absolute bottom-4 left-4 text-me-bg font-semibold text-lg playfair uppercase">
          {biodata.name}
        </h3>
      </div>
