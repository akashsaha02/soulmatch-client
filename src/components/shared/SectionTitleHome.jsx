...
const SectionTitleHome = () => {
    return (
        <div className="pt-10 pb-5 flex flex-col items-center">
            <p className="cinzel font-bold uppercase md:text-lg text-me-darkOrange">Trusted Brand</p>
            <h2 className="text-3xl md:text-4xl font-bold playfair text-me-brown">Recent Couples</h2>
