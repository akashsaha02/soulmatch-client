...
const slides = [{ image: slide1 }, { image: slide2 }];

export default function Banner() {
  const router = useRouter();
  return (
    <div className="relative min-h-[80vh] flex justify-center items-center text-white">
      ...
      <div className="absolute z-20 text-center px-6">
        <p className="playfair text-xl uppercase">
          <span className="text-4xl">#1</span> Matrimony
        </p>
        ...
        <p className="mt-2 md:text-xl">Most trusted Matrimony Brand in the World.</p>
        <div className="mt-8 bg-black/30 backdrop-blur-sm p-4 rounded-lg shadow-lg text-black w-full max-w-3xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            />
            <select className="border border-gray-300 p-3 font-bold text-me-brown rounded placeholder:font-bold placeholder:text-me-brown focus:outline-none focus:ring-2 focus:ring-me-orange">
